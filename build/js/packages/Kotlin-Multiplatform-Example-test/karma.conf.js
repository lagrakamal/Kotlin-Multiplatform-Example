...
config.set({
  "singleRun": true,
  "autoWatch": false,
  "basePath": "F:\\S5\\WPF\\Kotlin-Multiplatform-Example\\build\\js\\packages\\Kotlin-Multiplatform-Example-test\\node_modules",
  "files": [
    "F:\\S5\\WPF\\Kotlin-Multiplatform-Example\\build\\js\\packages\\Kotlin-Multiplatform-Example-test\\adapter-browser.js"
  ],
  "frameworks": [
    "mocha"
  ],
...
;(function(config) {
    ...
    const handler = (percentage, message, ...args) => {
        ...
        msg = msg.replace("F:\\S5\\WPF\\Kotlin-Multiplatform-Example\\build\\js", '');;
        console.log(msg);
    };
